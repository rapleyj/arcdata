...
ActiveRecord::Schema.define(version: 20131215000113) do
  ...
  add_index "incidents_attachments", ["person_id"], name: "index_incidents_attachments_on_person_id", using: :btree
